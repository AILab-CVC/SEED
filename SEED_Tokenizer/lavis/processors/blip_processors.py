...
@registry.register_processor("blip_image_eval_beit2")
class BlipImageEvalBeit2Processor(BlipImageBaseProcessor):
    def __init__(self, image_size=384, mean=None, std=None):
        super().__init__(mean=mean, std=std)
...
@registry.register_processor("blip2_image_train_beit2")
class Blip2ImageTrainBeit2Processor(BlipImageBaseProcessor):
    def __init__(
        self, image_size=364, mean=None, std=None, min_scale=0.5, max_scale=1.0
    ):
        super().__init__(mean=mean, std=std)
...
@registry.register_processor("blip2_image_train_mage")
class Blip2ImageTrainMageProcessor(BlipImageBaseProcessor):
    def __init__(
        self, image_size=364, mean=None, std=None, min_scale=0.5, max_scale=1.0
    ):
        super().__init__(mean=mean, std=std)
