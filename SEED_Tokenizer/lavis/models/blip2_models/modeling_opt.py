...
class OPTDecoder(OPTPreTrainedModel):
    ...
    def forward(
        ...
        if input_ids is not None and inputs_embeds is not None:
            ...
            inputs_embeds_new = self.embed_tokens(input_ids)
            inputs_embeds = torch.cat([inputs_embeds, inputs_embeds_new], dim=1)
...
class OPTForCausalLM(OPTPreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            #print(labels.shape, logits_ori.shape, logits.shape, shift_logits.shape, shift_labels.shape)
            # Flatten the tokens
