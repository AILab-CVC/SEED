...
class T5LayerNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        #print(hidden_states.shape, variance.shape)
...
class T5Block(nn.Module):
    ...
    def forward(
        ...
        #print(self.is_decoder, attention_mask, layer_head_mask)
...
class T5PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, T5LayerNorm):
            ...
            # if hasattr(module, "lm_head_both") and not self.config.tie_word_embeddings:
            #     module.lm_head_both.weight.data.normal_(mean=0.0, std=factor * 1.0)
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config: T5Config):
        ...
        #self.lm_head_both = nn.Linear(config.d_model, config.vocab_size+1024, bias=False)
    ...
    def parallelize(self, device_map=None):
        ...
        #self.lm_head_both = self.lm_head_both.to(self.decoder.first_device)
        self.model_parallel = True
    ...
    def deparallelize(self):
        ...
        #self.lm_head_both = self.lm_head_both.to("cpu")
        self.model_parallel = False
        self.device_map = None
        torch.cuda.empty_cache()
    ...
    def forward(
        ...
        if encoder_outputs is None:
            ...
            #print(input_ids None,attention_mask.shape,inputs_embeds.shape,head_mask None,output_attentions None,output_hidden_states None)
        elif return_dict and not isinstance(encoder_outputs, BaseModelOutput):
            encoder_outputs = BaseModelOutput(
                last_hidden_state=encoder_outputs[0],
                hidden_states=encoder_outputs[1] if len(encoder_outputs) > 1 else None,
        ...
        #print(decoder_input_ids.shape, decoder_attention_mask.shape, decoder_inputs_embeds, past_key_values, hidden_states.shape, attention_mask, decoder_head_mask, cross_attn_head_mask,
        ...
        if self.model_parallel:
            ...
            #self.lm_head_both = self.lm_head_both.to(self.encoder.first_device)
        ...
        #lm_logits = self.lm_head_both(sequence_output)
